 ...
 * @{ */
  ...
  *
  *   bit 3-4: encode how user cuts are added to Gurobi
  *            0 (+0) as GRB_USECUT_FILTER, i.e., "The cut is treated exactly
  *                   as cuts generated by GUROBI; that is, GUROBI applies its
  *                   filtering process and can possibly not even add the cut
  *                   to the relaxation, for example, if GUROBI deems other
  *                   cuts more effective, or if the cut is too dense."
  *            1 (+8) as GRB_USECUT_PURGE, i.e., "The cut is added to the
  *                   relaxation but can be purged later on if GUROBI deems
  *                   the cut ineffective."
  *            2 (+16) as GRB_USECUT_FORCE, i.e., "The cut is added to the
