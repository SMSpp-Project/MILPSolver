...
const std::array< std::pair< std::string, int >, SCIP_NUM_DBL_PARS >
 SCIPMILPSolver::SCIP_to_SMSpp_dbl_pars{
 {
  ...
  { "limits/objectivestop", dblFirstSCIPPar + 21 },
  { "lp/conditionlimit", dblFirstSCIPPar + 22 },
  { "lp/minmarkowitz", dblFirstSCIPPar + 23 },
  { "lp/rowrepswitch", dblFirstSCIPPar + 24 },
  { "lp/resolveiterfac", dblFirstSCIPPar + 25 },
  { "memory/savefac", dblFirstSCIPPar + 26 },
  { "memory/arraygrowfac", dblFirstSCIPPar + 27 },
  { "memory/treegrowfac", dblFirstSCIPPar + 28 },
  { "memory/pathgrowfac", dblFirstSCIPPar + 29 },
  { "misc/referencevalue", dblFirstSCIPPar + 30 },
  { "numerics/infinity", dblFirstSCIPPar + 31 },
  { "numerics/epsilon", dblFirstSCIPPar + 32 },
  { "numerics/sumepsilon", dblFirstSCIPPar + 33 },
  { "numerics/feastol", dblFirstSCIPPar + 34 },
  { "numerics/checkfeastolfac", dblFirstSCIPPar + 35 },
  { "numerics/lpfeastolfactor", dblFirstSCIPPar + 36 },
  { "numerics/dualfeastol", dblFirstSCIPPar + 37 },
  { "numerics/barrierconvtol", dblFirstSCIPPar + 38 },
  { "numerics/boundstreps", dblFirstSCIPPar + 39 },
  { "numerics/pseudocosteps", dblFirstSCIPPar + 40 },
  { "numerics/pseudocostdelta", dblFirstSCIPPar + 41 },
  { "numerics/recomputefac", dblFirstSCIPPar + 42 },
  { "numerics/hugeval", dblFirstSCIPPar + 43 },
  { "presolving/abortfac", dblFirstSCIPPar + 44 },
  { "presolving/restartfac", dblFirstSCIPPar + 45 },
  { "presolving/clqtablefac", dblFirstSCIPPar + 46 },
  { "presolving/immrestartfac", dblFirstSCIPPar + 47 },
  { "presolving/subrestartfac", dblFirstSCIPPar + 48 },
  { "presolving/restartminred", dblFirstSCIPPar + 49 },
  { "pricing/abortfac", dblFirstSCIPPar + 50 },
  { "benders/solutiontol", dblFirstSCIPPar + 51 },
  { "reoptimization/objsimrootLP", dblFirstSCIPPar + 52 },
  { "reoptimization/objsimsol", dblFirstSCIPPar + 53 },
  { "reoptimization/delay", dblFirstSCIPPar + 54 },
  { "separating/maxbounddist", dblFirstSCIPPar + 55 },
  { "separating/maxlocalbounddist", dblFirstSCIPPar + 56 },
  { "separating/maxcoefratio", dblFirstSCIPPar + 57 },
  { "separating/maxcoefratiofacrowprep", dblFirstSCIPPar + 58 },
  { "separating/minefficacy", dblFirstSCIPPar + 59 },
  { "separating/minefficacyroot", dblFirstSCIPPar + 60 },
  { "separating/minactivityquot", dblFirstSCIPPar + 61 },
  { "separating/maxcutsgenfactor", dblFirstSCIPPar + 62 },
  { "separating/maxcutsrootgenfactor", dblFirstSCIPPar + 63 },
  { "concurrent/sync/freqinit", dblFirstSCIPPar + 64 },
  { "concurrent/sync/freqmax", dblFirstSCIPPar + 65 },
  { "concurrent/sync/freqfactor", dblFirstSCIPPar + 66 },
  { "concurrent/sync/targetprogress", dblFirstSCIPPar + 67 },
  { "concurrent/sync/minsyncdelay", dblFirstSCIPPar + 68 },
 }
};
