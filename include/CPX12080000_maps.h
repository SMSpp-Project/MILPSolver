...
const std::array< std::pair< int, int >, CPX_NUM_DBL_PARS >
 ...
 {
  { CPX_PARAM_CFILEMUL, dblFirstCPLEXPar + 0 },
  { CPX_PARAM_EPMRK, dblFirstCPLEXPar + 1 },
  { CPX_PARAM_EPOPT, dblFirstCPLEXPar + 2 },
  { CPX_PARAM_EPPER, dblFirstCPLEXPar + 3 },
  { CPX_PARAM_EPRHS, dblFirstCPLEXPar + 4 },
  { CPX_PARAM_OBJLLIM, dblFirstCPLEXPar + 5 },
  { CPX_PARAM_OBJULIM, dblFirstCPLEXPar + 6 },
  { CPX_PARAM_RFILEMUL, dblFirstCPLEXPar + 7 },
  { CPX_PARAM_SINGTOL, dblFirstCPLEXPar + 8 },
  { CPX_PARAM_TILIM, dblFirstCPLEXPar + 9 },
  { CPX_PARAM_WORKMEM, dblFirstCPLEXPar + 10 },
  { CPX_PARAM_TUNINGTILIM, dblFirstCPLEXPar + 11 },
  { CPX_PARAM_DETTILIM, dblFirstCPLEXPar + 12 },
  { CPX_PARAM_TUNINGDETTILIM, dblFirstCPLEXPar + 13 },
  { CPX_PARAM_BENDERSFEASCUTTOL, dblFirstCPLEXPar + 14 },
  { CPX_PARAM_BENDERSOPTCUTTOL, dblFirstCPLEXPar + 15 },
  { CPX_PARAM_BTTOL, dblFirstCPLEXPar + 16 },
  { CPX_PARAM_CUTLO, dblFirstCPLEXPar + 17 },
  { CPX_PARAM_CUTUP, dblFirstCPLEXPar + 18 },
  { CPX_PARAM_EPAGAP, dblFirstCPLEXPar + 19 },
  { CPX_PARAM_EPGAP, dblFirstCPLEXPar + 20 },
  { CPX_PARAM_EPINT, dblFirstCPLEXPar + 21 },
  { CPX_PARAM_OBJDIF, dblFirstCPLEXPar + 22 },
  { CPX_PARAM_RELOBJDIF, dblFirstCPLEXPar + 23 },
  { CPX_PARAM_TRELIM, dblFirstCPLEXPar + 24 },
  { CPX_PARAM_CUTSFACTOR, dblFirstCPLEXPar + 25 },
  { CPX_PARAM_PROBETIME, dblFirstCPLEXPar + 26 },
  { CPX_PARAM_POLISHTIME, dblFirstCPLEXPar + 27 },
  { CPX_PARAM_EPRELAX, dblFirstCPLEXPar + 28 },
  { CPX_PARAM_SOLNPOOLGAP, dblFirstCPLEXPar + 29 },
  { CPX_PARAM_SOLNPOOLAGAP, dblFirstCPLEXPar + 30 },
  { CPX_PARAM_POLISHAFTEREPAGAP, dblFirstCPLEXPar + 31 },
  { CPX_PARAM_POLISHAFTEREPGAP, dblFirstCPLEXPar + 32 },
  { CPX_PARAM_POLISHAFTERTIME, dblFirstCPLEXPar + 33 },
  { CPX_PARAM_PROBEDETTIME, dblFirstCPLEXPar + 34 },
  { CPX_PARAM_POLISHAFTERDETTIME, dblFirstCPLEXPar + 35 },
  { CPX_PARAM_RAMPUPDETTILIM, dblFirstCPLEXPar + 36 },
  { CPX_PARAM_RAMPUPTILIM, dblFirstCPLEXPar + 37 },
  { CPX_PARAM_BAREPCOMP, dblFirstCPLEXPar + 38 },
  { CPX_PARAM_BARGROWTH, dblFirstCPLEXPar + 39 },
  { CPX_PARAM_BAROBJRNG, dblFirstCPLEXPar + 40 },
  { CPX_PARAM_BARQCPEPCOMP, dblFirstCPLEXPar + 41 },
  { CPX_PARAM_NETEPOPT, dblFirstCPLEXPar + 42 },
  { CPX_PARAM_NETEPRHS, dblFirstCPLEXPar + 43 },
 }
};
