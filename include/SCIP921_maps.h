...
const std::array< std::pair< std::string, int >, SCIP_NUM_DBL_PARS >
 SCIPMILPSolver::SCIP_to_SMSpp_dbl_pars{
 {
  ...
  { "limits/primal", dblFirstSCIPPar + 21 },
  { "limits/dual", dblFirstSCIPPar + 22 },
  { "lp/conditionlimit", dblFirstSCIPPar + 23 },
  { "lp/minmarkowitz", dblFirstSCIPPar + 24 },
  { "lp/rowrepswitch", dblFirstSCIPPar + 25 },
  { "lp/resolveiterfac", dblFirstSCIPPar + 26 },
  { "memory/savefac", dblFirstSCIPPar + 27 },
  { "memory/arraygrowfac", dblFirstSCIPPar + 28 },
  { "memory/treegrowfac", dblFirstSCIPPar + 29 },
  { "memory/pathgrowfac", dblFirstSCIPPar + 30 },
  { "misc/referencevalue", dblFirstSCIPPar + 31 },
  { "numerics/infinity", dblFirstSCIPPar + 32 },
  { "numerics/epsilon", dblFirstSCIPPar + 33 },
  { "numerics/sumepsilon", dblFirstSCIPPar + 34 },
  { "numerics/feastol", dblFirstSCIPPar + 35 },
  { "numerics/checkfeastolfac", dblFirstSCIPPar + 36 },
  { "numerics/lpfeastolfactor", dblFirstSCIPPar + 37 },
  { "numerics/dualfeastol", dblFirstSCIPPar + 38 },
  { "numerics/barrierconvtol", dblFirstSCIPPar + 39 },
  { "numerics/boundstreps", dblFirstSCIPPar + 40 },
  { "numerics/pseudocosteps", dblFirstSCIPPar + 41 },
  { "numerics/pseudocostdelta", dblFirstSCIPPar + 42 },
  { "numerics/recomputefac", dblFirstSCIPPar + 43 },
  { "numerics/hugeval", dblFirstSCIPPar + 44 },
  { "presolving/abortfac", dblFirstSCIPPar + 45 },
  { "presolving/restartfac", dblFirstSCIPPar + 46 },
  { "presolving/clqtablefac", dblFirstSCIPPar + 47 },
  { "presolving/immrestartfac", dblFirstSCIPPar + 48 },
  { "presolving/subrestartfac", dblFirstSCIPPar + 49 },
  { "presolving/restartminred", dblFirstSCIPPar + 50 },
  { "pricing/abortfac", dblFirstSCIPPar + 51 },
  { "benders/solutiontol", dblFirstSCIPPar + 52 },
  { "reoptimization/objsimrootLP", dblFirstSCIPPar + 53 },
  { "reoptimization/objsimsol", dblFirstSCIPPar + 54 },
  { "reoptimization/delay", dblFirstSCIPPar + 55 },
  { "separating/maxbounddist", dblFirstSCIPPar + 56 },
  { "separating/maxlocalbounddist", dblFirstSCIPPar + 57 },
  { "separating/maxcoefratio", dblFirstSCIPPar + 58 },
  { "separating/maxcoefratiofacrowprep", dblFirstSCIPPar + 59 },
  { "separating/minefficacy", dblFirstSCIPPar + 60 },
  { "separating/minefficacyroot", dblFirstSCIPPar + 61 },
  { "separating/minactivityquot", dblFirstSCIPPar + 62 },
  { "separating/maxcutsgenfactor", dblFirstSCIPPar + 63 },
  { "separating/maxcutsrootgenfactor", dblFirstSCIPPar + 64 },
  { "concurrent/sync/freqinit", dblFirstSCIPPar + 65 },
  { "concurrent/sync/freqmax", dblFirstSCIPPar + 66 },
  { "concurrent/sync/freqfactor", dblFirstSCIPPar + 67 },
  { "concurrent/sync/targetprogress", dblFirstSCIPPar + 68 },
  { "concurrent/sync/minsyncdelay", dblFirstSCIPPar + 69 },
 }
};
