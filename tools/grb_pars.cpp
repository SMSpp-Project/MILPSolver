...
int main( int argc, char ** argv ) {
 ...
 std::string GRB_VERSION = std::to_string( GRB_VERSION_MAJOR ) + std::to_string( GRB_VERSION_MINOR ) + std::to_string( GRB_VERSION_TECHNICAL );
...
// Generate maps file
 ...
 maps_file
  << "const std::array< std::pair< std::string, int >, GRB_NUM_INT_PARS >" << std::endl
 ...
 maps_file
  << "const std::array< std::pair< std::string, int >, GRB_NUM_DBL_PARS >" << std::endl
 ...
 maps_file
  << "const std::array< std::pair< std::string, int >, GRB_NUM_STR_PARS >" << std::endl
