...
#        PIPS::PIPS                 Imported target                           #
# --------------------------------------------------------------------------- #

include(FindPackageHandleStandardArgs)

# PIPSMILPSolver uses internal PIPS-IPM++ headers, so locate the source tree
# rather than only an installation prefix.  Both the checkout root and its
# PIPS-IPM subdirectory are accepted as hints.
find_path(PIPS_SOURCE_ROOT
        ...
        "$ENV{PIPSIPM_ROOT}"
        PATHS "$ENV{HOME}/pips-ipmpp/PIPS-IPM"
...
if (NOT PIPS_LINEAR_SOLVERS_LIB_DIR AND PIPS_CORE_LIB_DIR)
    set(PIPS_LINEAR_SOLVERS_LIB_DIR
            ...
            "Directory containing the PIPS-IPM++ solver adapter libraries.")
endif ()
...
# ----- PIPS-IPM++ and adapter libraries ----------------------------------- #
